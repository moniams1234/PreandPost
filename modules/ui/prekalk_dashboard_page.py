"""prekalk_dashboard_page.py — PreKalkulacja Kokpit in app(6) layout."""
from __future__ import annotations

import streamlit as st

from modules.ui.app6_views import render_app6_dashboard, find_client_col


def render() -> None:
    st.markdown("# 🎯 PreKalkulacja — Kokpit")
    ...
    render_app6_dashboard(df_pk, grp_col, tpm_thr, cm_thr, key_prefix="_pk_kok")
