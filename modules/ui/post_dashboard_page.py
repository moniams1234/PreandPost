"""post_dashboard_page.py — PostKalkulacja Kokpit in app(6) layout."""
from __future__ import annotations

import streamlit as st

from modules.calculations.profitability_engine import exclude_oticon_zam_rows
from modules.ui.app6_views import render_app6_dashboard
...
def render(result: dict, tpm_thr: float, cm_thr: float) -> None:
    ...
    render_app6_dashboard(df_all, grp_col, tpm_thr, cm_thr, key_prefix="_post_kok")
