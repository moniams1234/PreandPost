        ...
        if df_zlec is not None:
            ...
            if nzp_z and wart_z:
                ...
                if rows_for_zlec.any():
                    ...
                    df.loc[idx_sales, "Data faktury"] = matched_sales.loc[idx_sales, "_matched_date"].values
                    df.loc[matched_sales.index, "_matched_source"] = matched_sales["_matched_source"].values
